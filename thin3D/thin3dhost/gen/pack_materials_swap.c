/* THIS FILE IS AUTOGENERATED FROM pack_materials.c BY pack_swap.py */
...
static void __handleMaterialData( GLenum face, GLenum pname, const GLfloat *params )
{
    ...
    WRITE_DATA( sizeof( int ) + 0, GLenum, SWAP32(face) );
...
void PACK_APIENTRY crPackMaterialfvSWAP(GLenum face, GLenum pname, const GLfloat *params)
{
    CR_GET_PACKER_CONTEXT(pc);
...
void PACK_APIENTRY crPackMaterialivSWAP(GLenum face, GLenum pname, const GLint *params)
{
