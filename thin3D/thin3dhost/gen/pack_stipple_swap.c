/* THIS FILE IS AUTOGENERATED FROM pack_stipple.c BY pack_swap.py */
...
void PACK_APIENTRY crPackPolygonStippleSWAP( const GLubyte *mask )
{
    ...
    WRITE_DATA_AI(int, SWAP32(nodata) );
    if (nodata)
    {
        WRITE_DATA_AI(GLint, SWAP32((GLint)(uintptr_t)mask) );
    }
    else
    {
