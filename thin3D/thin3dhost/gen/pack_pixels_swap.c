/* THIS FILE IS AUTOGENERATED FROM pack_pixels.c BY pack_swap.py */
...
void PACK_APIENTRY crPackDrawPixelsSWAP(GLsizei width, GLsizei height,
                                    ...
                                    const CRPixelPackState *unpackstate )
{
    ...
    if (!noimagedata)
    {
        ...
        if (imagesize<=0)
        {
            crDebug("crPackDrawPixels:SWAP 0 image size, ignoring");
            return;
        }
    ...
    WRITE_DATA( 0, GLsizei, SWAP32(width) );
    WRITE_DATA( 4, GLsizei, SWAP32(height) );
    WRITE_DATA( 8, GLenum, SWAP32(format) );
    WRITE_DATA( 12, GLenum, SWAP32(type) );
    WRITE_DATA( 16, GLint, SWAP32(noimagedata) );
    WRITE_DATA( 20, GLint, SWAP32((GLint) (uintptr_t) pixels) );
...
void PACK_APIENTRY crPackReadPixelsSWAP(GLint x, GLint y, GLsizei width,
                                    ...
                                    int *writeback)
{
    ...
    *writeback = 0;
    ...
    if (bytes_per_pixel <= 0) {
        char string[80];
        sprintf(string, "crPackReadPixelsSWAP(format 0x%x or type 0x%x)", format, type);
    ...
    WRITE_DATA( 24, GLint, SWAP32(stride) );
    WRITE_DATA( 28, GLint, SWAP32(packstate->alignment) );
    WRITE_DATA( 32, GLint, SWAP32(packstate->skipRows) );
    WRITE_DATA( 36, GLint, SWAP32(packstate->skipPixels) );
    WRITE_DATA( 40, GLint, SWAP32(bytes_per_row) );
    WRITE_DATA( 44, GLint, SWAP32(packstate->rowLength) );
...
void PACK_APIENTRY crPackBitmapSWAP(GLsizei width, GLsizei height,
                                ...
                                const GLubyte *bitmap, const CRPixelPackState *unpack )
{
    ...
    WRITE_DATA( 0, GLsizei, SWAP32(width) );
    WRITE_DATA( 4, GLsizei, SWAP32(height) );
    WRITE_DATA( 8, GLuint, SWAPFLOAT(xorig) );
    WRITE_DATA( 12, GLuint, SWAPFLOAT(yorig) );
    WRITE_DATA( 16, GLuint, SWAPFLOAT(xmove) );
    WRITE_DATA( 20, GLuint, SWAPFLOAT(ymove) );
    WRITE_DATA( 24, GLuint, SWAP32(noimagedata) );
    WRITE_DATA( 28, GLint, SWAP32((GLint) (uintptr_t) bitmap) );
...
*/
void PACK_APIENTRY crPackZPixCRSWAP( GLsizei width, GLsizei height,
        GLenum format, GLenum type,
...
*/
    data_ptr = (unsigned char *) crPackAlloc( packet_length );
    WRITE_DATA( 0, GLenum, SWAP32(CR_ZPIXCR_EXTEND_OPCODE) );
    WRITE_DATA( 4, GLsizei, SWAP32(width) );
    WRITE_DATA( 8, GLsizei, SWAP32(height) );
    WRITE_DATA( 12, GLenum, SWAP32(format) );
    WRITE_DATA( 16, GLenum, SWAP32(type) );
    WRITE_DATA( 20, GLenum, SWAP32(ztype) );
    WRITE_DATA( 24, GLint, SWAP32(zparm) );
    WRITE_DATA( 28, GLint, SWAP32(length) );
...
void PACK_APIENTRY
crPackGetTexImageSWAP( GLenum target, GLint level, GLenum format, GLenum type,
                                     ...
                                     int * writeback )
{
    ...
    WRITE_DATA( 4, GLenum, SWAP32(CR_GETTEXIMAGE_EXTEND_OPCODE) );
