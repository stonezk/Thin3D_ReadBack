/* THIS FILE IS AUTOGENERATED FROM pack_bufferobject.c BY pack_swap.py */
...
void PACK_APIENTRY
crPackMapBufferARBSWAP( GLenum target, GLenum access,
...
void PACK_APIENTRY
crPackUnmapBufferARBSWAP( GLenum target, GLboolean* return_value, int * writeback )
{
     (void)target;
     (void)return_value;
     (void)writeback;
