/* THIS FILE IS AUTOGENERATED FROM pack_fog.c BY pack_swap.py */
...
void PACK_APIENTRY crPackFogfvSWAP(GLenum pname, const GLfloat *params)
{
    CR_GET_PACKER_CONTEXT(pc);
...
void PACK_APIENTRY crPackFogivSWAP(GLenum pname, const GLint *params)
{
    CR_GET_PACKER_CONTEXT(pc);
