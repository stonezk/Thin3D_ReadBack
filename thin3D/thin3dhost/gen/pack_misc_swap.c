/* THIS FILE IS AUTOGENERATED FROM pack_misc.c BY pack_swap.py */
...
void PACK_APIENTRY crPackChromiumParametervCRSWAP(CR_PACKER_CONTEXT_ARGDECL GLenum target, GLenum type, GLsizei count, const GLvoid *values)
{
    ...
    default:
        __PackError( __LINE__, __FILE__, GL_INVALID_ENUM,
                                 "crPackChromiumParametervCRSWAP(bad type)" );
        return;
    }
    ...
    WRITE_DATA( 4, GLenum, SWAP32(CR_CHROMIUMPARAMETERVCR_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLenum, SWAP32(target) );
    WRITE_DATA( 12, GLenum, SWAP32(type) );
    WRITE_DATA( 16, GLsizei, SWAP32(count) );
    ...
    case GL_UNSIGNED_SHORT:
        for (i = 0; i < count; i++, pos += sizeof(GLshort)) {
            WRITE_DATA( pos, GLshort, SWAP16(((GLshort *) values)[i]) );
        }
        break;
    case GL_INT:
    case GL_UNSIGNED_INT:
        for (i = 0; i < count; i++, pos += sizeof(GLint)) {
            WRITE_DATA( pos, GLint, SWAP32(((GLint *) values)[i]) );
        }
        break;
#ifndef IN_RING0
    case GL_FLOAT:
        for (i = 0; i < count; i++, pos += sizeof(GLfloat)) {
            WRITE_DATA( pos, GLuint, SWAPFLOAT(((GLfloat *) values)[i]) );
        }
        break;
#endif
#if 0
...
void PACK_APIENTRY crPackDeleteQueriesARBSWAP(CR_PACKER_CONTEXT_ARGDECL GLsizei n, const GLuint * ids)
{
    ...
    WRITE_DATA( 0, GLenum, SWAP32(CR_DELETEQUERIESARB_EXTEND_OPCODE) );
...
void PACK_APIENTRY crPackVBoxTexPresentSWAP( CR_PACKER_CONTEXT_ARGDECL GLuint texture, GLuint cfg, GLint xPos, GLint yPos, GLint cRects, const GLint * pRects )
{
    ...
    WRITE_DATA( 0, GLint, SWAP32(size) );
    WRITE_DATA( 4, GLenum, SWAP32(CR_VBOXTEXPRESENT_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLuint, SWAP32(texture) );
    WRITE_DATA( 12, GLuint, SWAP32(cfg) );
    WRITE_DATA( 16, GLint, SWAP32(xPos) );
    WRITE_DATA( 20, GLint, SWAP32(yPos) );
    WRITE_DATA( 24, GLint, SWAP32(cRects) );

    cnt = 28;
    for (i=0; i<cRects; ++i)
    {
        WRITE_DATA( cnt, GLint, SWAP32((GLint) pRects[4*i+0]) );
        WRITE_DATA( cnt+4, GLint, SWAP32((GLint) pRects[4*i+1]) );
        WRITE_DATA( cnt+8, GLint, SWAP32((GLint) pRects[4*i+2]) );
        WRITE_DATA( cnt+12, GLint, SWAP32((GLint) pRects[4*i+3]) );
        cnt += 16;
    }
    WRITE_OPCODE( pc, CR_EXTEND_OPCODE );
    CR_UNLOCK_PACKER_CONTEXT(pc);
...
void PACK_APIENTRY crPackWindowPositionSWAP( CR_PACKER_CONTEXT_ARGDECL GLint window, GLint x, GLint y )
{
    ...
    WRITE_DATA( 4, GLenum, SWAP32(CR_WINDOWPOSITION_EXTEND_OPCODE) );
...
void PACK_APIENTRY crPackWindowShowSWAP( CR_PACKER_CONTEXT_ARGDECL GLint window, GLint flag )
{
    ...
    WRITE_DATA( 4, GLenum, SWAP32(CR_WINDOWSHOW_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLint, SWAP32(window) );
    WRITE_DATA( 12, GLint, SWAP32(flag) );
    WRITE_OPCODE( pc, CR_EXTEND_OPCODE );
    CR_UNLOCK_PACKER_CONTEXT(pc);
}
...
void PACK_APIENTRY crPackWindowSizeSWAP( CR_PACKER_CONTEXT_ARGDECL GLint window, GLint w, GLint h )
{
    ...
    CR_GET_BUFFERED_POINTER( pc, 20 );
    WRITE_DATA( 0, GLint, SWAP32(20) );
    WRITE_DATA( 4, GLenum, SWAP32(CR_WINDOWSIZE_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLint, SWAP32(window) );
    WRITE_DATA( 12, GLint, SWAP32(w) );
    WRITE_DATA( 16, GLint, SWAP32(h) );
    WRITE_OPCODE( pc, CR_EXTEND_OPCODE );
    CR_UNLOCK_PACKER_CONTEXT(pc);
}
...
void PACK_APIENTRY crPackBeginQueryARBSWAP( CR_PACKER_CONTEXT_ARGDECL GLenum target, GLuint id )
{
    ...
    CR_GET_BUFFERED_POINTER( pc, 16 );
    WRITE_DATA( 0, GLint, SWAP32(16) );
    WRITE_DATA( 4, GLenum, SWAP32(CR_BEGINQUERYARB_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLenum, SWAP32(target) );
...
void PACK_APIENTRY crPackEndQueryARBSWAP( CR_PACKER_CONTEXT_ARGDECL GLenum target )
{
    ...
    WRITE_DATA( 4, GLenum, SWAP32(CR_ENDQUERYARB_EXTEND_OPCODE) );
    WRITE_DATA( 8, GLenum, SWAP32(target) );
    WRITE_OPCODE( pc, CR_EXTEND_OPCODE );
    CR_UNLOCK_PACKER_CONTEXT(pc);
}
