...
#include "../crserverlib/server.h"



void crUnpackExtendMultiDrawArraysEXT(void)
{
	
	GLenum mode = READ_DATA( 8, GLenum );
	GLvoid *pdata = DATA_POINTER( 12, GLvoid );


	cr_unpackDispatch.MultiDrawArraysEXT( mode, pdata, NULL,  0 );
	return;
	...
	//cr_server.head_spu->dispatch_table.MultiDrawArraysEXT
}
